            ...
            endpoints: [
                ...
                { method: 'GET', path: '/api/ready' },
                {
                    contracts: [
                        ...
                        {
                            method: 'GET',
                            path: '/api/contracts/contractors',
                        },
                        {
                            method: 'GET',
                            path: '/api/contracts/contractors/:id',
                        },
                        {
                            method: 'GET',
                            path: '/api/contracts/contractors/:id/awarded-contracts',
                        },
                        {
                            method: 'GET',
                            path: '/api/contracts/contractors/:id/realised-contracts',
                        },
                    ],
                },
            ],
